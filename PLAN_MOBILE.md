...
> **Versión:** 2.0.0
> **Fecha:** 2026-07-08
> **Stack:** React Native + Expo (latest) | API REST (Portal Client API v1)
...
| **Navegación** | Expo Router + Native Bottom Tabs | 4.x |
| **Estilos** | NativeWind (Tailwind CSS para RN) | 4.x |
| **Gestión de Estado** | Zustand | 5.x |
| **Data Fetching** | TanStack Query (React Query) | 5.x |
| **HTTP Client** | Axios | 1.x |
| **Validación** | Zod | 3.x |
| **Almacenamiento Seguro** | expo-secure-store | 3.x |
| **Listas Virtualizadas** | FlashList (@shopify/flash-list) | 1.x |
| **Notificaciones Push** | expo-notifications | 0.x |
